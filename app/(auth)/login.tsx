      ...
      >
        ...
        >
          <View className="flex-1 justify-between px-6 py-4">
            ...
            <View className="gap-3 max-w-md w-full align-self-center mx-auto">
              {/* Option 1: Email Login Form */}
              <View className="rounded-2xl border border-accent/20 bg-bgSurface2/80 p-5 gap-3.5 shadow-lg shadow-accent/5">
              ...
              <View className="flex-row items-center justify-center gap-2 py-0.5">
                <View className="h-[1px] flex-1 bg-bgBorder" />
                <Text className="text-[10px] font-semibold uppercase tracking-widest text-textTertiary">
                  OR
                </Text>
                <View className="h-[1px] flex-1 bg-bgBorder" />
              </View>

              {/* Option 2: Google Login (Placed Below) */}
              <View>
                <GoogleButton
